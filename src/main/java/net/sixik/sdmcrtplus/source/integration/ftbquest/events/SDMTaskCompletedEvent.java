...
public class SDMTaskCompletedEvent extends Event {
    ...
    private Date time;
    public SDMTaskCompletedEvent(Task object, Task task, TeamData data, List<ServerPlayer> onlineMembers, List<ServerPlayer> notifiedPlayers, Date time){
        this.object = object;
        this.task = task;
        this.teamData = data;
