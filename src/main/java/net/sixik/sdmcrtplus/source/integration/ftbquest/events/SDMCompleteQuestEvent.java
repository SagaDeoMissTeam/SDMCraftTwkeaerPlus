...
public class SDMCompleteQuestEvent extends Event {
    private Quest quest;
    ...
    public SDMCompleteQuestEvent(Quest quest, Quest object, TeamData data, List<ServerPlayer> onlineMembers, List<ServerPlayer> notifiedPlayers, Date time){
        this.quest = quest;
        this.object = object;
        this.data = data;
